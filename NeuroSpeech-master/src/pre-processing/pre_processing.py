...
class pre_processing():
    ...
    self def normalize(data_audio): # normalize speech frame
    ...
    self def resample(data_audio, fs1, fs2): 
        """
    ...
    self def normalizeDB(path_audios_in, path_audios_out):
    ...
    self def resampleDB(path_audios):
